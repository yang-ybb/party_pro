    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center">党建管理系统</div>
            </div>     

            <div class="panel-body" >

                <form name="login-form" id="form" class="form-horizontal" enctype="multipart/form-data" action="loginAction" method="POST">
