		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="info-edit-form-common" accept-charset="UTF-8" action="manageUserCommitUpdate" method="post" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-md-2 control-label">入党申请书：</label>
                            <div class="col-md-1">
                                <input type="text" id="rudangshenqingshu" class="form-control commit" 
                                	value="${commit.getRudangshenqingshu()}" name="rudangshenqingshu"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="jijifenzikaochabiao" class="form-control commit" 
                                	value="${commit.getJijifenzikaochabiao()}" name="jijifenzikaochabiao"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="tuiyourudang" class="form-control commit" 
                                	value="${commit.getTuiyourudang()}" name="tuiyourudang"/>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="sixianghuibao" class="form-control commit" 
                                	value="${commit.getSixianghuibao()}" name="sixianghuibao"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="zhengshencailiao" class="form-control commit" 
                                	value="${commit.getZhengshencailiao()}" name="zhengshencailiao"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="zhengshenbaogao" class="form-control commit" 
                                	value="${commit.getZhengshenbaogao()}" name="zhengshenbaogao"/>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="qunzhongyijian" class="form-control commit" 
                                	value="${commit.getQunzhongyijian()}" name="qunzhongyijian"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="dangxiaojieyezheng" class="form-control commit" 
                                	value="${commit.getDangxiaojieyezheng()}" name="dangxiaojieyezheng"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="zizhuan" class="form-control commit" 
                                	value="${commit.getZizhuan()}" name="zizhuan"/>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="fazhandangyuangongshi" class="form-control commit" 
                                	value="${commit.getFazhandangyuangongshi()}" name="fazhandangyuangongshi"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="zhibudahuijilu" class="form-control commit" 
                                	value="${commit.getZhibudahuijilu()}" name="zhibudahuijilu"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="rudangzhiyuanshu" class="form-control commit" 
                                	value="${commit.getRudangzhiyuanshu()}" name="rudangzhiyuanshu"/>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="banqizongjie" class="form-control commit" 
                                	value="${commit.getBanqizongjie()}" name="banqizongjie"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="quannianzongjie" class="form-control commit" 
                                	value="${commit.getQuannianzongjie()}" name="quannianzongjie"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="zhuanzhengshenqing" class="form-control commit" 
                                	value="${commit.getZhuanzhengshenqing()}" name="zhuanzhengshenqing"/>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="zhuanzhenggongshi" class="form-control commit" 
                                	value="${commit.getZhuanzhenggongshi()}" name="zhuanzhenggongshi"/>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="yubeidangyuankaochabiao" class="form-control commit" 
                                	value="${commit.getYubeidangyuankaochabiao()}" name="yubeidangyuankaochabiao"/>
                            </div>
                            <div class="col-md-1">
