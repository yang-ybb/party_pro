		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="info-edit-form-manage" accept-charset="UTF-8" action="manageUserInfoUpdate" method="post" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-md-2 control-label">姓名：</label>
                            <div class="col-md-2">
                                <input type="text" id="name" class="form-control input" value="${user.getName()}" name="name"/>
                            </div>
                            <label class="col-md-2 control-label">学号：</label>
                            <div class="col-md-2">
                                <input type="text" id="studentid" class="form-control input" value="${user.getStudentid()}" name="studentid"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">班级：</label>
                            <div class="col-md-2">
                                <input type="text" id="uclass" class="form-control input" value="${user.getUclass()}" name="uclass"/>
                            </div>
                            <label class="col-md-2 control-label">籍贯：</label>
                            <div class="col-md-2">
                                <input type="text" id="origo" class="form-control input" value="${user.getOrigo()}" name="origo"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" id="nation" class="form-control input" value="${user.getNation()}" name="nation"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">出生日期：</label>
                            <div class="col-md-2">
                                <input type="text" id="birthday" class="form-control date-in" value="${user.getBirthday()}" name="birthday"/>
                            </div>
                            <label class="col-md-2 control-label">宿舍：</label>
                            <div class="col-md-2">
                                <input type="text" id="dormitory" class="form-control input" value="${user.getDormitory()}" name="dormitory"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" id="applydate" class="form-control date-in" 
                                	value="${user.getApplydate()}" name="applydate"/>
                            </div>
                            <label class="col-md-2 control-label">定为积极分子时间：</label>
                            <div class="col-md-2">
                                <input type="text" id="be_activist_date" class="form-control date-in" 
                                	value="${user.getBe_activist_date()}" name="be_activist_date"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">党课通过时间：</label>
                            <div class="col-md-2">
                                <input type="text" id="be_passpartyclass_date" class="form-control date-in" 
                                	value="${user.getBe_passpartyclass_date()}" name="be_passpartyclass_date"/>
                            </div>
                            <label class="col-md-2 control-label">定为发展对象时间：</label>
                            <div class="col-md-2">
                                <input type="text" id="be_target_date" class="form-control date-in" 
                                	value="${user.getBe_target_date()}" name="be_target_date"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">发展时间：</label>
                            <div class="col-md-2">
                                <input type="text" id="be_probationary_date" class="form-control date-in" 
                                	value="${user.getBe_probationary_date()}" name="be_probationary_date"/>
                            </div>
                            <label class="col-md-2 control-label">转正时间：</label>
                            <div class="col-md-2">
                                <input type="text" id="be_fullmember_date" class="form-control date-in" 
                                	value="${user.getBe_fullmember_date()}" name="be_fullmember_date"/>
                            </div>
                        </div>
