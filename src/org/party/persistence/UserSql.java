...
public class UserSql {	
     ...
     * 获得指定党支部中所有的成员信息
     */
    public static List<User> getUserListInPartybranch(SqlSession session, Integer partybranchid){
        return session.selectList("getUserListInPartybranch",partybranchid);
    }
}
